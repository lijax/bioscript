...
phylo_gene_result = "/home/yeyanbo/baculovirus_new/56_phylo_gene_result2"
...
for clade in clades_inner:
	...
	phylo_gene_file.write(clade.name)
	phylo_gene_file.write(",R%s|1.0,%s,%s\n" % (num_cur, num_cur - num_pre, num_pre))
...
for clade in clades_ter:
	...
	phylo_gene_file.write("%s,R%s|1.0,%s,%s\n" % (term_name, num_cur, num_cur - num_pre, num_pre))
